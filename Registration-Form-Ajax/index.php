               ...
               <form class="needs-validation" action="indexnN.php"  method="POST" novalidate>
                  <div class="row g-3">
                     <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="nNidNumber" id="nNidNumber" placeholder="" value="" maxlength="3" required>
                     ...
                     <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="nNBloodGroup" id="nNBloodGroup" placeholder="" required>
                        <div class="invalid-feedback">
                     ...
                     <div class="col-md-4">
                        <label for="nNhobbies" class="form-label">Hobbies</label>
